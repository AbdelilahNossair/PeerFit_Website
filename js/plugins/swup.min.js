! function (t, e) {
        ...
        r = (t, n, o, i) => {
            ...
            return function (t, n, o, i = {}) {
                ...
                const {
                    once: a,
                    ...c
                } = i, l = s instanceof Document ? s.documentElement : s, h = Boolean("object" == typeof i ? i.capture : i), u = i => {
                ...
                e(!0, l, o, d) || l.addEventListener(n, u, c), r?.addEventListener("abort", () => {
                    e(!1, l, o, d)
                })
            }(t, n, o, i = {
                ...i,
    ...
    class s extends URL {
        constructor(t, e) {
            void 0 === e && (e = document.baseURI), super(t.toString(), e), Object.setPrototypeOf(this, s.prototype)
        }
        get url() {
        ...
        try {
            ...
            function n(n) {
                ...
                return Promise.resolve(u.text()).then(function (n) {
                    if (500 === r) throw o.hooks.call("fetch:error", i, {
                        status: r,
                        response: u,
                        url: a
                    }), new c(`Server error: ${a}`, {
                        status: r,
                        url: a
                    });
                    if (!n) throw new c(`Empty response: ${a}`, {
                        status: r,
                        url: a
                    });
                    const {
            ...
            const {
                ...
                ...e.headers
            }, a = e.timeout ?? o.options.timeout, l = new AbortController, {
                signal: h
            } = l;
            e = {
                ...e,
            ...
            const m = function (n, r) {
                try {
                    var s = Promise.resolve(o.hooks.call("fetch:request", i, {
                        url: t,
                        options: e
                    }, (t, e) => {
                        let {
                ...
                if (d) throw o.hooks.call("fetch:timeout", i, {
                    url: t
                }), new c(`Request timed out: ${t}`, {
                    url: t,
                    timedOut: d
                });
                if ("AbortError" === e?.name || h.aborted) throw new c(`Request aborted: ${t}`, {
                    url: t,
                    aborted: !0
                });
                throw e
            ...
            try {
                ...
                const s = [],
                    a = function (t, e, n) {
                        ...
                        if (!e?.done) return l && r.off(i, a),
                            function (t, o) {
                                try {
                                    var i = Promise.resolve(function (t, e) {
                                        return void 0 === e && (e = []), new Promise((n, o) => {
                                            const i = t(...e);
                                            f(i) ? i.then(n, o) : n(i)
                                        })
                                    }(a, [e, n, c])).then(function (t) {
                                        s.push(t)
                                    })
                                } catch (t) {
                                    return o(t)
    ...
    const S = t => {
            ...
            let n = document.getElementById(t) || document.getElementById(e) || h(`a[name='${CSS.escape(t)}']`) || h(`a[name='${CSS.escape(e)}']`);
        ...
        E = function (t) {
            ...
            try {
                ...
                let t = [];
                if (n) t = Array.from(n);
                else if (e && (t = u(e, document.body), !t.length)) return console.warn(`[swup] No elements found matching animationSelector \`${e}\``), Promise.resolve();
    ...
    const H = function (t, e) {
        ...
        try {
            ...
            function r(r) {
                ...
                return "string" == typeof u && (t.animation.name = u), "object" == typeof e.cache ? (t.cache.read = e.cache.read ?? t.cache.read, t.cache.write = e.cache.write ?? t.cache.write) : void 0 !== e.cache && (t.cache = {
                        read: !!e.cache,
                        write: !!e.cache
                    }), delete e.cache,
                    function (r, a) {
                                ...
                                try {
                                    var l = Promise.resolve(c.hooks.call("visit:start", t, void 0)).then(function () {
                                        ...
                                        a.then(e => {
                                            ...
                                            t.advance(5), t.to.html = n, t.to.document = (new DOMParser).parseFromString(n, "text/html")
                                        });
                                        const l = t.to.url + t.to.hash;
                                        t.history.popstate || ("replace" === t.history.action || t.to.url === c.location.url ? i(l) : (c.currentHistoryIndex++, function (t, e) {
                                            void 0 === e && (e = {});
                                            const n = {
                                                url: t = t || o({
                                                    hash: !0
                                        ...
                                        }))), c.location = s.fromUrl(l), t.history.popstate && c.classes.add("is-popstate"), t.animation.name && c.classes.add(`to-${n(t.animation.name)}`);
                                        const h = function () {
    ...
    function T(t, e, n) {
        ...
        const {
            url: o,
            hash: i
        } = s.fromUrl(t), r = this.createVisit({
            ...n,
            to: o,
            hash: i
        });
    ...
    const j = function (t) {
        ...
        V = function (t) {
            const e = {
                ...
                i = n ?? t.to.hash;
            let r = !1;
            return i && (r = this.hooks.callSync("scroll:anchor", t, {
                hash: i,
                options: e
            }, (t, e) => {
                let {
            ...
            })), o && !r && (r = this.hooks.callSync("scroll:top", t, {
                options: e
            }, (t, e) => {
                let {
                    options: n
        ...
        q = function (t, e) {
            try {
                ...
                return r.isSameResolvedUrl(o(), a) || (i(a), r.location = s.fromUrl(a), t.to.url = r.location.url, t.to.hash = r.location.hash), Promise.resolve(r.hooks.call("content:replace", t, {
                    page: e
                }, (t, e) => {
    ...
    return class {
        ...
        constructor(t) {
            void 0 === t && (t = {}), this.version = "4.7.0", this.options = void 0, this.defaults = W, this.plugins = [], this.visit = void 0, this.cache = void 0, this.hooks = void 0, this.classes = void 0, this.location = s.fromUrl(window.location.href), this.currentHistoryIndex = void 0, this.clickDelegate = void 0, this.navigating = !1, this.onVisitEnd = void 0, this.use = R, this.unuse = N, this.findPlugin = D, this.log = () => {}, this.navigate = T, this.performNavigation = H, this.createVisit = g, this.delegateEvent = r, this.fetchPage = a, this.awaitAnimations = E, this.renderPage = q, this.replaceContent = L, this.animatePageIn = I, this.animatePageOut = j, this.scrollToContent = V, this.getAnchorElement = S, this.getCurrentUrl = o, this.resolveUrl = M, this.isSameResolvedUrl = O, this.options = {
                ...this.defaults,
                ...t
            }, this.handleLinkClick = this.handleLinkClick.bind(this), this.handlePopState = this.handlePopState.bind(this), this.cache = new l(this), this.classes = new p(this), this.hooks = new b(this), this.visit = this.createVisit({
                to: ""
        ...
        shouldIgnoreVisit(t, e) {
            ...
            return i !== window.location.origin || !(!n || !this.triggerWillOpenNewWindow(n)) || !!this.options.ignoreVisit(r + a, {
                el: n,
                event: o
            })
        }
        handleLinkClick(t) {
            ...
            const a = this.createVisit({
                to: o,
                hash: r,
                el: e,
                event: t
            });
            t.metaKey || t.ctrlKey || t.shiftKey || t.altKey ? this.hooks.callSync("link:newtab", a, {
                href: n
            }) : 0 === t.button && this.hooks.callSync("link:click", a, {
                el: e,
                event: t
            }, () => {
                const e = a.from.url ?? "";
                t.preventDefault(), o && o !== e ? this.isSameResolvedUrl(o, e) || this.performNavigation(a) : r ? this.hooks.callSync("link:anchor", a, {
                    hash: r
                }, () => {
                    i(o + r), this.scrollToContent(a)
                }) : this.hooks.callSync("link:self", a, void 0, () => {
                    "navigate" === this.options.linkToSelf ? this.performNavigation(a) : (i(o), this.scrollToContent(a))
                })
            })
        }
        handlePopState(t) {
            ...
            const {
                url: n,
                hash: i
            } = s.fromUrl(e), r = this.createVisit({
                to: n,
                hash: i,
                event: t
            });
            ...
            a && a !== this.currentHistoryIndex && (r.history.direction = a - this.currentHistoryIndex > 0 ? "forwards" : "backwards", this.currentHistoryIndex = a), r.animation.animate = !1, r.scroll.reset = !1, r.scroll.target = !1, this.options.animateHistoryBrowsing && (r.animation.animate = !0, r.scroll.reset = !0), this.hooks.callSync("history:popstate", r, {
                event: t
            }, () => {
...
// source map removed to avoid 404 in production
